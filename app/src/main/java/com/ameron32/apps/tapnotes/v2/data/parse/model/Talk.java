...
import static com.ameron32.apps.tapnotes.v2.data.parse.Constants.TALK_DATE_STRING_KEY;
import static com.ameron32.apps.tapnotes.v2.data.parse.Constants.TALK_DURATIONMINUTES_NUMBER_KEY;
import static com.ameron32.apps.tapnotes.v2.data.parse.Constants.TALK_HEADERIMAGEURL_STRING_KEY;
import static com.ameron32.apps.tapnotes.v2.data.parse.Constants.TALK_METADATA_STRING_KEY;
import static com.ameron32.apps.tapnotes.v2.data.parse.Constants.TALK_OBJECT_NAME;
import static com.ameron32.apps.tapnotes.v2.data.parse.Constants.TALK_SCRIPTURES_STRING_KEY;
import static com.ameron32.apps.tapnotes.v2.data.parse.Constants.TALK_TITLE_STRING_KEY;
