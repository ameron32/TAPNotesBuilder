        ...
        if (iTalks != null) {
            for (ITalk iTalk : iTalks) {
                if (iTalk instanceof Talk) {
                    ...
                    throw new IllegalArgumentException("Cannot convert " + ITalk.class.getSimpleName()
                            + " to " + Talk.class.getSimpleName() + ". One or more " + ITalk.class.getSimpleName()
                            + " is not of type " + Talk.class.getSimpleName() + ".");
                }
            }
        }
        return talks;
